...
class OptionPracticeScreen extends StatefulWidget {
  // final List<Word> words;
  final bool hideKorean;
  const OptionPracticeScreen({super.key, required this.hideKorean});

  @override
  State<OptionPracticeScreen> createState() => _OptionPracticeScreenState();
}

class _OptionPracticeScreenState extends State<OptionPracticeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text(widget.hideKorean ? '🇪🇸 Español' : '🈶 Coreano')),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                widget.hideKorean
                                    ? capitalizeFirstLetter(item.spanish)
                                    : item.korean,
